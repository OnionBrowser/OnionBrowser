...
then
    curl -Lo ./Resources/geoip https://gitweb.torproject.org/tor.git/plain/src/config/geoip?h=tor-0.4.4.6
    curl -Lo ./Resources/geoip6 https://gitweb.torproject.org/tor.git/plain/src/config/geoip6?h=tor-0.4.4.6
fi
