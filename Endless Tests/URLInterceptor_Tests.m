...
- (void)testCSPHeaderInjection
{
	...
	NSString *outp3 = [URLInterceptor prependDirectivesIfExisting:@{ @"child-src": @"endlessipc:", @"frame-src": @"endlessipc:", @"script-src" : @"'none'" } inCSPHeader:@"referrer always;"];
	XCTAssert([outp3 isEqualToString:@"referrer always;"]);
}
